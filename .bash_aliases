...
if [[ "${PLATFORM-}" == "darwin" ]]; then
  ...
  alias backup_info='tmutil destinationinfo'
  alias backup_status='tmutil status'
  alias backups='tmutil listbackups'
  alias disable_backups='tmutil disable'
  alias enable_backups='tmutil enable'
  alias local_backups='tmutil listlocalsnapshots /'
  alias prune_backups='tmutil thinlocalsnapshots / 10000000000' # 10gb
  alias start_backup='tmutil startbackup'
  alias stop_backup='tmutil stopbackup'
fi
